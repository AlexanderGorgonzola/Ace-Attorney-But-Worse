...
class Buttons:
    ...
    def prep_health(self, hp):
        ...
        self.bad_health_rect = pygame.Rect(0,0, 200, 50)
        ...
        self.bad_health_rect.top = self.screen_rect.top + 100
        self.bad_health_rect.left = self.screen_rect.left
    ...
    def show_buttons(self):
        ...
        self.screen.fill((255,0,0), self.bad_health_rect)
